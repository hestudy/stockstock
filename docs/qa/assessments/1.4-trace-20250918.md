...
- Tests: `apps/web/src/utils/__tests__/export.test.ts`（应覆盖成功/失败分支）
- Page/UI: `apps/web/src/app/(dashboard)/backtests/[id]/page.tsx`（导出入口与失败提示）
