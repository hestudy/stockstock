...
Gate File
- `docs/qa/gates/1.3-backtest-submit.yml`
...
| 2025-09-13   | v0.5    | QA 修复：测试环境默认禁用 /api/health 速率限制；补充 backtests.service 500/超时测试；新增 backtests.page a11y 断言；全量测试通过 | James (dev) |
