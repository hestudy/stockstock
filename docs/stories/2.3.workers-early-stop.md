...
- `python3 -m pytest services/backtest/tests/test_worker.py services/backtest/tests/test_orchestrator.py services/backtest/tests/test_main_internal_optimizations.py`
